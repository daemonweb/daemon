...
export interface ApiItemItem extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    autoManage: BooleanAttribute;
    cloverId: UIDAttribute;
    name: StringAttribute & RequiredAttribute;
    price: DecimalAttribute & RequiredAttribute;
    alternateName: StringAttribute;
    code: StringAttribute;
    sku: StringAttribute;
    defaultTaxRates: BooleanAttribute & DefaultTo<true>;
    unitName: StringAttribute;
    cost: IntegerAttribute;
    isRevenue: BooleanAttribute & DefaultTo<true>;
    stockCount: IntegerAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
